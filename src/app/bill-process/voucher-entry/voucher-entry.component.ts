...
export class VoucherEntryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //Bill entry form
    this.VoucherEntryForm = new FormGroup({
  ...
  getBillTypeList() {
    ...
    this.ApiMethods.getservice(this.ApiService.BillTypeList + 1).subscribe((resp:any) => {
      ...
      if (resp.result && resp.result.length > 0) {
        ...
        this.BillTypeList = this.VoucherEntryForm.controls['Billtype'].valueChanges.pipe(
          startWith(''),
  ...
  OnBilltypeSelected() {
    this.SelectBilltype = this.VoucherEntryForm.value.Billtype

    console.log("slelction__________option_____Biltypoe", this.SelectBilltype, this.VoucherEntryForm.value.Billtype);
    ...
    if (this.SelectBilltype.Ncode == 2 ||this.SelectBilltype.Ncode == 1) {
  ...
  getBillSubTypeList(data: any) {
    ...
    this.ApiMethods.getservice(this.ApiService.BillSubType + data + '/' + 0).subscribe((resp:any) => {
      ...
      if (resp.result && resp.result.length > 0) {
        ...
        this.BillSubTypeList = this.VoucherEntryForm.controls['BillSubType'].valueChanges.pipe(
          startWith(''),
  ...
  getObjectHeadList(SelectBillSubtype: any) {
    this.ApiMethods.getservice(this.ApiService.GetObjectHeadCodelist + this.SelectBilltype.Ncode + '/' + SelectBillSubtype).subscribe((resp:any) => {
      console.log("ObjectList__res", resp);
      if (resp.result && resp.result.length > 0) {
        this.ObjectHeadList = resp.result;
        this.ObjectHeadList = this.VoucherEntryForm.controls['ObjectHead'].valueChanges.pipe(
          startWith(''),
          map((value: any) => {
  ...
  getDdoNameList() {
    this.ApiMethods.getservice(this.ApiService.getDdoNamelist + this.Tcode.Treasury_Code + '/0').subscribe((resp:any) => {
      ...
      if (resp.result && resp.result.length > 0) {
        ...
        this.DodoNameList = this.VoucherEntryForm.controls['DdoName'].valueChanges.pipe(
          startWith(''),
          map((value: any) => {
  ...
  OnDdoNameSelected() {
    this.SelectDdoName = this.VoucherEntryForm.value.DdoName
    // console.log("slelction__________DdoName", this.SelectDdoName, this.VoucherEntryForm.value.DdoName);
  }
  ...
  BalanceBudgetCheck() {
    ...
    var Detailhead = this.VoucherEntryForm.controls['DetailHead'].value;
    var officeid = this.VoucherEntryForm.controls['officeid'].value;
    var BillMonth = this.VoucherEntryForm.controls['BillMonth'].value;


    var BFCType = this.VoucherEntryForm.controls['PlanNonPlan'].value;
    var Headtype = this.VoucherEntryForm.controls['VotedCharged'].value;
  ...
  Checkbillsave() {
    ...
    var Division = this.VoucherEntryForm.controls['Division'].value;
    var pdacc = this.VoucherEntryForm.controls['PdAcc'].value;
  ...
  CheckOfficeId() {
    ...
    this.ApiMethods.getservice(this.ApiService.OfficeId_Verify + this.Tcode.Treasury_Code + '/' + this.billentry_info.DDO_CODE + '/' + this.VoucherEntryForm.value.officeid).subscribe((resp:any) => {
  ...
  CheckBillNo() {
    var MajorH = this.VoucherEntryForm.value.DetailHead.slice(0, 4);
    this.loader.setLoading(true);
    let duplicatebil_body = {
      "finyear": this.Tcode.finyear,
      "treasuryCode": this.Tcode.Treasury_Code,
      "ddoCode": this.billentry_info.DDO_CODE,
      "ddoBillNo": this.VoucherEntryForm.value.DdoBillNo,
      "majorhead": MajorH
    }
    // Office id verify api call
  ...
  Save() {
    ...
    var DetailsH = this.VoucherEntryForm.controls['DetailHead'].value;
    var Division = this.VoucherEntryForm.controls['Division'].value;
    var ModeOfP = this.VoucherEntryForm.controls['ECSNONECS'].value;
    var ChequeD = this.VoucherEntryForm.controls['toDate'].value;
    var Detailhead = this.VoucherEntryForm.controls['DetailHead'].value;
    var MajorH = Detailhead.slice(0, 4);
    console.log("majorh_____save", MajorH, this.VoucherEntryForm.value.GrossAmt, this.VoucherEntryForm.value.PlanNonPlan, this.VoucherEntryForm.value.VotedCharged, this.Popup_error_list);

    console.log("pddd__acc___", this.check_pd_status, this.budgetamt);
    console.log("laksdjf+____", this.Bankselected);
    const bankId = this.VoucherEntryForm.value.bankName;
    ...
    if (this.Api_erroFlag) {
    ...
    else if (this.VoucherEntryForm.value.GrossAmt == 0) {
      this.snackbar.show('Gross Amount Should be greater then 0', 'danger')
    }
    else if (this.VoucherEntryForm.value.HeadGross > this.VoucherEntryForm.value.GrossAmt) {
      this.snackbar.show('Head gross should be equal or less than gross amount', 'danger')
    }
    else if (this.VoucherEntryForm.value.NetAmt > this.VoucherEntryForm.value.GrossAmt) {
      this.snackbar.show('Cash amount should be equal or less than gross amount', 'danger')
    }
    else if (this.VoucherEntryForm.value.ECSNONECS != 'A' && this.VoucherEntryForm.value.NetAmt == 0) {
    ...
    else if ((MajorH > 7999) && !(this.VoucherEntryForm.value.PlanNonPlan == 'A' && this.VoucherEntryForm.value.VotedCharged == 'A' && this.SelectObjectHead.objectHeadCode == '00')) {
      this.snackbar.show("Please Select Voted/Charged ,Plan/NonPlan to N.A. and ObjectHead to 00 select  ", 'danger')
    }
    else if (this.VoucherEntryForm.value.budgetval != this.SumBTAmt && this.OtherBTDeatls.length > 0) {
      this.snackbar.show("Bt Total amount should be equal to Diff of gross and cash amount", 'danger')
    }
    else if (this.VoucherEntryForm.value.budgetval != 0 && this.OtherBTDeatls.length == 0) {
      ...
      // let chequeDate = this.VoucherEntryForm.controls['toDate'].value;
  ...
  Show_moreBudgetHEad() {
    ...
    console.log("BTobjecttype_filter", MBobjecttype, this.VoucherEntryForm.value.ObjectHead);
    if (this.VoucherEntryForm.value.DetailHead.length < 13) {
      this.snackbar.show('Please Enter Detail Head', 'danger')
    }
    else if (!this.SelectObjectHead) {
      this.snackbar.show('Please Select Object Head', 'danger')
    }
    else if (!this.VoucherEntryForm.value.officeid) {
      this.snackbar.show('Please Enter Office ID', 'danger')
    }
    else if (!this.VoucherEntryForm.value.VotedCharged) {
      this.snackbar.show('Please Select Head type', 'danger')
    }
    else if (!this.VoucherEntryForm.value.PlanNonPlan) {
      this.snackbar.show('Please Select BFC type', 'danger')
    }
    else if (!this.VoucherEntryForm.value.GrossAmt) {
      this.snackbar.show('Please Enter Gross Amount', 'danger')
    }
    else if (!this.VoucherEntryForm.value.HeadGross) {
      ...
      this.MoreHForm.patchValue({
        MB_DetailHead: this.VoucherEntryForm.value.DetailHead,
        MB_PlanNonPlan: this.VoucherEntryForm.value.PlanNonPlan,
        MB_VotedCharged: this.VoucherEntryForm.value.VotedCharged,
      })
      this.SelectMBObjectHead = MBobjecttype
      console.log("more__jhead_De__", this.VoucherEntryForm.value.DetailHead, this.VoucherEntryForm.value.PlanNonPlan, this.VoucherEntryForm.value.VotedCharged, this.SelectObjectHead);

      this.VoucherEntryForm.get('officeid').disable();
      this.VoucherEntryForm.get('DetailHead').disable();
      this.VoucherEntryForm.get('ObjectHead').disable();
      this.VoucherEntryForm.get('VotedCharged').disable();
      this.VoucherEntryForm.get('PlanNonPlan').disable();
      this.VoucherEntryForm.get('HeadGross').disable();
      this.VoucherEntryForm.get('GrossAmt').disable();
    }

  }

  Pension_Add() {
    var CashAMt = this.VoucherEntryForm.controls['NetAmt'].value
  ...
  RDCCD_Add() {
    var GroassAMt = this.VoucherEntryForm.value.GrossAmt
  ...
  Add_MoreH() {
    ...
    var GrossAmt = this.VoucherEntryForm.controls['GrossAmt'].value
    var HeadGroassAmt = this.VoucherEntryForm.controls['HeadGross'].value;
    var BudgetAmt = this.VoucherEntryForm.controls['BudgetBal'].value;
  ...
  onadd_NewBt() {
    ...
    // var GrossAmt = this.VoucherEntryForm.controls['GrossAmt'].value;
    var BalanceDiff = this.VoucherEntryForm.controls['budgetval'].value;
    ...
    // var NetAmt = this.VoucherEntryForm.controls['NetAmt'].value;
  ...
  onChange(UpdatedValue: any): void {
    let GrossAMT = this.VoucherEntryForm.controls['GrossAmt'].value;  //TokenNum controller
      ...
      if (this.loginflag && this.BillTypeForm.valid) {
        ...
        this.ApiMethods.postresultservice(this.ApiService.getofflinetoken, GetsalaryBody).subscribe((resp:any) => {
          ...
          if (resp.result.length > 0) {
            ...
            console.log("BillTypeForm==>>", this.VoucherEntryForm);
          }
          else {
  ...
  get DdoName() { return this.VoucherEntryForm.get('DdoName') }
  get DdoBillNo() { return this.VoucherEntryForm.get('DdoBillNo') }
  get officeid() { return this.VoucherEntryForm.get('officeid') }
  get DdoBillDate() { return this.VoucherEntryForm.get('DdoBillDate') }
  get Billtype() { return this.VoucherEntryForm.get('Billtype') }
  get PayMonth() { return this.VoucherEntryForm.get('PayMonth') }

  get BillSubType() { return this.VoucherEntryForm.get('BillSubType') }
  get DetailHead() { return this.VoucherEntryForm.get('DetailHead') }
  get ObjectHead() { return this.VoucherEntryForm.get('ObjectHead') }
  get ChequeDate() { return this.VoucherEntryForm.get('ChequeDate') }
  get Division() { return this.VoucherEntryForm.get('Division') }
  get GrossAmt() { return this.VoucherEntryForm.get('GrossAmt') }
  get NetAmt() { return this.VoucherEntryForm.get('NetAmt') }
  get PdAcc() { return this.VoucherEntryForm.get('PdAcc') }
  get HeadOffice() { return this.VoucherEntryForm.get('HeadOffice') }
  get BudgetBal() { return this.VoucherEntryForm.get('BudgetBal') }
  get budgetval() { return this.VoucherEntryForm.get('budgetval') }
  get HeadGross() { return this.VoucherEntryForm.get('HeadGross') }
  get BillMonth() { return this.VoucherEntryForm.get('BillMonth') }
  get BillYear() { return this.VoucherEntryForm.get('BillYear') }
